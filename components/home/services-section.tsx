      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="space-y-0">
          {services.map((service, index) => (
            <div 
              key={index}
              className={`reveal reveal-delay-${Math.min(index + 1, 5)} group border-t border-border py-8 lg:py-10 flex flex-col md:flex-row md:items-start gap-6 md:gap-12 hover:bg-secondary/50 transition-colors px-4 -mx-4`}
            >
