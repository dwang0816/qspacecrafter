      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div>
            ...
            <Link 
              href="/contact"
              className="group inline-flex items-center gap-3 px-8 py-4 bg-primary text-primary-foreground text-sm tracking-widest uppercase hover:bg-primary/90 transition-colors"
            >
              Get Started
          ...
          <div className="grid grid-cols-2 gap-4">
            {areas.map((area, index) => (
              <div 
                key={index}
                className="group p-6 lg:p-8 border border-border bg-card hover:bg-secondary hover:border-accent/30 transition-colors"
              >
                <MapPin className="h-5 w-5 text-accent mb-4" strokeWidth={1.5} />
